					...
					<div class="card mb-5 mb-xl-8">
						...
						<div class="card-body pt-15">
							...
							<div class="d-flex flex-center flex-column mb-5">
								...
								<!--end::Avatar-->
								<!--begin::Name-->
								<a href="#" class="fs-3 text-gray-800 text-hover-primary fw-bold mb-1">{{$dokter->nama}}</a>
								<!--end::Name-->
								<!--begin::Position-->
								<div class="fs-5 fw-semibold text-muted mb-6">Dokter Spesialis  {{ucwords($dokter->spesialis)}}</div>
								<!--end::Position-->
								<!--begin::Info-->
							...
							<div id="kt_customer_view_details" class="collapse show">
								<div class="py-5 fs-6">
									...
									<div class="text-gray-600">ID-000{{$dokter->id}}</div>
									<!--begin::Details item-->
									<!--begin::Details item-->
									<div class="fw-bold mt-5">Email</div>
									<div class="text-gray-600">
										<a href="#" class="text-gray-600 text-hover-primary">{{$dokter->email}}</a>
									</div>
									<!--begin::Details item-->
									<!--begin::Details item-->
									<div class="fw-bold mt-5">Address</div>
									<div class="text-gray-600">{{$dokter->alamat}} 
										<!-- <br />Melbourne 3000 VIC
										<br />Australia -->
									</div>
									<!--begin::Details item-->
									<!--begin::Details item-->
									<div class="fw-bold mt-5">Tanggal Bergabung</div>
									<div class="text-gray-600">{{date('d F Y', strtotime($dokter->tanggal_gabung))}}</div>
									<!--begin::Details item-->
									<!--begin::Details item-->
									<div class="fw-bold mt-5">Nomor Telepon</div>
									<div class="text-gray-600">{{$dokter->nomor_hp}}</div>
									<!--begin::Details item-->
									<!--begin::Details item-->
									<div class="fw-bold mt-5">Jenis Kelamin</div>
									<div class="text-gray-600">
										@if ($dokter->jenis_kelamin == 'L') Laki-laki 
										@else Perempuan
										@endif
									</div>
									<!--begin::Details item-->
								...
								<div class="card-body pt-0 pb-5">
									...
									<table class="table align-middle table-row-dashed gy-5" id="kt_table_customers_payment">
										...
										<tbody class="fs-6 fw-semibold text-gray-600">
											<tr>
												<td>
													<a href="#" class="text-gray-600 text-hover-primary mb-1">2901-7833</a>
												</td>
												<td>
											...
											<tr>
												<td>
													<a href="#" class="text-gray-600 text-hover-primary mb-1">7567-4233</a>
												</td>
												<td>
													<span class="badge badge-light-success">Successful</span>
												</td>
											...
											<tr>
												<td>
													<a href="#" class="text-gray-600 text-hover-primary mb-1">6306-7559</a>
												</td>
												<td>
													<span class="badge badge-light-success">Successful</span>
												</td>
											...
											<tr>
												<td>
													<a href="#" class="text-gray-600 text-hover-primary mb-1">4798-5192</a>
												</td>
												<td>
											...
											<tr>
												<td>
													<a href="#" class="text-gray-600 text-hover-primary mb-1">7653-6919</a>
												</td>
												<td>
													<span class="badge badge-light-success">Successful</span>
												</td>
											...
											<tr>
												<td>
													<a href="#" class="text-gray-600 text-hover-primary mb-1">2210-8963</a>
												</td>
												<td>
													<span class="badge badge-light-success">Successful</span>
												</td>
											...
											<tr>
												<td>
													<a href="#" class="text-gray-600 text-hover-primary mb-1">5608-2458</a>
												</td>
												<td>
													<span class="badge badge-light-success">Successful</span>
												</td>
											...
											<tr>
												<td>
													<a href="#" class="text-gray-600 text-hover-primary mb-1">4354-3580</a>
												</td>
												<td>
											...
											<tr>
												<td>
													<a href="#" class="text-gray-600 text-hover-primary mb-1">1996-3854</a>
												</td>
												<td>
													<span class="badge badge-light-warning">Pending</span>
												</td>
										...
										<table class="table align-middle table-row-dashed fw-semibold text-gray-600 fs-6 gy-5" id="kt_table_customers_logs">
											<tbody>
												<tr>
													...
													<td>POST /v1/invoices/in_6119_6216/payment</td>
												...
												<tr>
													...
													<td>POST /v1/invoices/in_3838_8328/payment</td>
												...
												<tr>
													...
													<td>POST /v1/invoices/in_3373_9729/payment</td>
												...
												<tr>
													...
													<td>POST /v1/customer/c_65a10a7d8a283/not_found</td>
												...
												<tr>
													...
													<td>POST /v1/invoice/in_2120_2902/invalid</td>
												...
												<tr>
													...
													<td>POST /v1/invoice/in_3501_6536/invalid</td>
													<td class="pe-0 text-end min-w-200px">15 Apr 2024, 8:43 pm</td>
												</tr>
												<tr>
													<td class="min-w-70px">
														<div class="badge badge-light-success">200 OK</div>
													</td>
													<td>POST /v1/invoices/in_9712_1784/payment</td>
													<td class="pe-0 text-end min-w-200px">19 Aug 2024, 6:05 pm</td>
												</tr>
												<tr>
													<td class="min-w-70px">
														<div class="badge badge-light-success">200 OK</div>
													...
													<td>POST /v1/invoices/in_3373_9729/payment</td>
													<td class="pe-0 text-end min-w-200px">10 Nov 2024, 10:10 pm</td>
												</tr>
												<tr>
													<td class="min-w-70px">
														<div class="badge badge-light-success">200 OK</div>
													</td>
													<td>POST /v1/invoices/in_5745_6615/payment</td>
													<td class="pe-0 text-end min-w-200px">25 Jul 2024, 5:20 pm</td>
												</tr>
												<tr>
													<td class="min-w-70px">
														<div class="badge badge-light-danger">500 ERR</div>
													</td>
													<td>POST /v1/invoice/in_1293_7154/invalid</td>
													<td class="pe-0 text-end min-w-200px">20 Jun 2024, 9:23 pm</td>
												</tr>
											</tbody>
										</table>
									</div>
									...
									<table class="table align-middle table-row-dashed fs-6 text-gray-600 fw-semibold gy-5" id="kt_table_customers_events">
										<tbody>
											<tr>
												...
												<td class="pe-0 text-gray-600 text-end min-w-200px">19 Aug 2024, 2:40 pm</td>
											</tr>
											<tr>
												<td class="min-w-400px">Invoice 
												<a href="#" class="fw-bold text-gray-900 text-hover-primary me-1">#SEP-45656</a>status has changed from 
												<span class="badge badge-light-warning me-1">Pending</span>to 
												<span class="badge badge-light-info">In Progress</span></td>
												<td class="pe-0 text-gray-600 text-end min-w-200px">20 Dec 2024, 9:23 pm</td>
											</tr>
											<tr>
												<td class="min-w-400px">Invoice 
												<a href="#" class="fw-bold text-gray-900 text-hover-primary me-1">#SEP-45656</a>status has changed from 
												<span class="badge badge-light-warning me-1">Pending</span>to 
												<span class="badge badge-light-info">In Progress</span></td>
												<td class="pe-0 text-gray-600 text-end min-w-200px">15 Apr 2024, 6:43 am</td>
											</tr>
											<tr>
												<td class="min-w-400px">Invoice 
												...
												<td class="pe-0 text-gray-600 text-end min-w-200px">24 Jun 2024, 8:43 pm</td>
											</tr>
											<tr>
											...
											<tr>
												...
												<a href="#" class="fw-bold text-gray-900 text-hover-primary">#XRS-45670</a></td>
												<td class="pe-0 text-gray-600 text-end min-w-200px">20 Dec 2024, 11:30 am</td>
											</tr>
											<tr>
												<td class="min-w-400px">
												<a href="#" class="text-gray-600 text-hover-primary me-1">Emma Smith</a>has made payment to 
