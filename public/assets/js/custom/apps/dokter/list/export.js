...
var KTCustomersExport = function() {
    ...
    return {
        init: function() {
            t = document.querySelector("#kt_dokters_export_modal"),
            a = new bootstrap.Modal(t),
            i = document.querySelector("#kt_dokters_export_form"),
            e = i.querySelector("#kt_dokters_export_submit"),
            n = i.querySelector("#kt_dokters_export_cancel"),
            o = t.querySelector("#kt_dokters_export_close"),
