        ...
        init:function(){
            ...
            r=FormValidation.formValidation(i,
                ...
                e.addEventListener("click",(function(t){t.preventDefault(),
                    r&&r.validate().then((function(t){console.log("validated!"),
                ...
                n.addEventListener("click",(function(t){
                    ...
                    }).then((function(t){t.value?(i.reset(),
                    ...
                    o.addEventListener("click",(function(t){t.preventDefault(),
                        Swal.fire({text:"Are you sure you would like to cancel?",
                        icon:"warning",
                        ...
                        a.hide()):"cancel"===t.dismiss&&Swal.fire({text:"Your form has not been cancelled!.",
                        icon:"error",buttonsStyling:!1,confirmButtonText:"Ok, got it!",
                        customClass:{confirmButton:"btn btn-primary"}
                    })
                }))})),function(){const t=i.querySelector("[name=date]");
